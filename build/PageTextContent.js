...
var PageTextContent = function (_Component) {
  ...
  function PageTextContent() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = PageTextContent.__proto__ || (0, _getPrototypeOf2.default)(PageTextContent)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var getDivComponents = function getDivComponents(highlightInfo) {
        var divComponents = {
          prefix: textItem.str
        };
        ...
        if (highlightInfo) {
          ...
          if (itemIndex === highlightInfo.begin.divIdx && itemIndex === highlightInfo.end.divIdx) {
            begin = highlightInfo.begin.offset; // Match is fully contained in div
            end = highlightInfo.end.offset;
          } else if (itemIndex === highlightInfo.begin.divIdx && itemIndex < highlightInfo.end.divIdx) {
            begin = highlightInfo.begin.offset; // Match begins in this div
            end = textItem.str.length;
          } else if (itemIndex === highlightInfo.end.divIdx && itemIndex > highlightInfo.begin.divIdx) {
      ...
      var _getDivComponents = getDivComponents(highlight),
          prefix = _getDivComponents.prefix,
          highlightedText = _getDivComponents.highlightedText,
          suffix = _getDivComponents.suffix;
      ...
      return _react2.default.createElement(
        ...
        prefix,
        highlightedText && highlightedText.length && _react2.default.createElement(
          'span',
          {
            style: {
